...
HD_PWD='E:/FESC/SISTEMAS DIGITALES/vga_iniciales/vga_iniciales.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log vga_iniciales.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source vga_iniciales.tcl -notrace
