...
HD_PWD='E:/FESC/SISTEMAS DIGITALES/vga_iniciales/vga_iniciales.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log vga_iniciales.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source vga_iniciales.tcl
